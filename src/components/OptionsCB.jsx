...
export default class OptionsCB extends Component {
    ...
    render() {
        let { gender = '', designation = '', department = '' } = this.props.options;
        let { departmentsArr, designationsArr, genderArr } = this.props;
        return (
            <div className="container">
                <div className="row">
                    <div className="col-sm-12">
                        {this.showRadios(departmentsArr, 'Select Department', 'department', department)}
                        <br />
                        {this.showRadios(designationsArr, 'Select Designation', 'designation', designation)}
                        <br />
                        {this.showRadios(genderArr, 'Select Gender', 'gender', gender)}
                        <br />
                    </div>
                </div>
            </div>
